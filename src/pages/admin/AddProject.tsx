...
export default function AddProject() {
  ...
  // Initialize technologies input only once when component mounts
  useEffect(() => {
    ...
    <div className="p-6">
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-secondary-800 mb-2">Add New Project</h1>
            <p className="text-secondary-600">Create a new project and assign team members</p>
          </div>
          <button
